...
- As a new learner, I can create a profile with a unique handle (letters/numbers/underscore, stored without `@`; UI adds the `@` prefix), birth year + month, country, and languages so I can be discoverable by partners.
